...
public class DataConverterTest {
	...
	public void testConvertDataFromInput() {
		...
		HashMap<String, String> weatherDataMap=null;
		try {
			weatherDataMap = dc.initializeWeatherDataMap();
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		String[] actualRealTime = dc.convertDataFromInput(inputRealTime,weatherDataMap);
		...
		String[] actualMongoDB = dc.convertDataFromInput(inputMongoDB,weatherDataMap);
		...
		List<String> input;
		String date = "2017_12_14";
		try {
			input = dc.loadDataFile("../sampleData/sampleWeatherData.json");
			dc.weatherDataFormatConverter(input,date);
